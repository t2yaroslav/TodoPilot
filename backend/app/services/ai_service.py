...
async def generate_survey_step(
    ...
    if step == 1:
        ...
        prompt = (
            ...
            "а также предыдущей ретроспективы, предложи ОДНО самое важное и конкретное изменение "
    ...
    messages = [
        {
            ...
            "content": (
                ...
                "ОБЯЗАТЕЛЬНО определи и укажи пол/род пользователя (м/ж) на основе окончаний "
                "в его ответах (например «сделала» → ж, «закончил» → м). Если пол уже указан "
                "в текущем портрете — сохрани его, если появились новые данные — обнови. "
                "Пиши в третьем лице, кратко. Отвечай на русском языке. "
                "Формат — связный текст, 3-7 предложений. "
